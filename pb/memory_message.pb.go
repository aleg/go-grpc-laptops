...
const (
	Memory_UNKNOWN  Memory_Unit = 0 // always use a default
...
type Memory struct {
	...
	Unit  Memory_Unit `protobuf:"varint,2,opt,name=unit,proto3,enum=aleg.laptops.Memory_Unit" json:"unit,omitempty"`
}
...
var file_memory_message_proto_rawDesc = []byte{
	...
	0x74, 0x6f, 0x70, 0x73, 0x22, 0xad, 0x01, 0x0a, 0x06, 0x4d, 0x65, 0x6d, 0x6f, 0x72, 0x79, 0x12,
	...
	0x01, 0x28, 0x0e, 0x32, 0x19, 0x2e, 0x61, 0x6c, 0x65, 0x67, 0x2e, 0x6c, 0x61, 0x70, 0x74, 0x6f,
	0x70, 0x73, 0x2e, 0x4d, 0x65, 0x6d, 0x6f, 0x72, 0x79, 0x2e, 0x55, 0x6e, 0x69, 0x74, 0x52, 0x04,
	...
	0x54, 0x45, 0x10, 0x06, 0x42, 0x24, 0x5a, 0x22, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63,
...
var file_memory_message_proto_goTypes = []interface{}{
	(Memory_Unit)(0), // 0: aleg.laptops.Memory.Unit
	(*Memory)(nil),   // 1: aleg.laptops.Memory
}
var file_memory_message_proto_depIdxs = []int32{
	0, // 0: aleg.laptops.Memory.unit:type_name -> aleg.laptops.Memory.Unit
