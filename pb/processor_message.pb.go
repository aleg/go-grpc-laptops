...
type CPU struct {
	...
	NumberCores   uint32  `protobuf:"varint,3,opt,name=number_cores,json=numberCores,proto3" json:"number_cores,omitempty"`       // positive integer
	NumberThreads uint32  `protobuf:"varint,4,opt,name=number_threads,json=numberThreads,proto3" json:"number_threads,omitempty"` // positive integer
...
var file_processor_message_proto_rawDesc = []byte{
	...
	0x61, 0x67, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x0c, 0x61, 0x6c, 0x65, 0x67, 0x2e,
	0x6c, 0x61, 0x70, 0x74, 0x6f, 0x70, 0x73, 0x1a, 0x14, 0x6d, 0x65, 0x6d, 0x6f, 0x72, 0x79, 0x5f,
	...
	0x14, 0x2e, 0x61, 0x6c, 0x65, 0x67, 0x2e, 0x6c, 0x61, 0x70, 0x74, 0x6f, 0x70, 0x73, 0x2e, 0x4d,
	0x65, 0x6d, 0x6f, 0x72, 0x79, 0x52, 0x06, 0x6d, 0x65, 0x6d, 0x6f, 0x72, 0x79, 0x42, 0x24, 0x5a,
	0x22, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x61, 0x6c, 0x65, 0x67,
	0x2f, 0x67, 0x6f, 0x2d, 0x67, 0x72, 0x70, 0x63, 0x2d, 0x6c, 0x61, 0x70, 0x74, 0x6f, 0x70, 0x73,
...
var file_processor_message_proto_goTypes = []interface{}{
	(*CPU)(nil),    // 0: aleg.laptops.CPU
	(*GPU)(nil),    // 1: aleg.laptops.GPU
	(*Memory)(nil), // 2: aleg.laptops.Memory
}
var file_processor_message_proto_depIdxs = []int32{
	2, // 0: aleg.laptops.GPU.memory:type_name -> aleg.laptops.Memory
